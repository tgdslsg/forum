    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <img id="avatar" src="http://ohwn5gb62.bkt.clouddn.com/${sessionScope.curr_user.avatar}?imageView2/1/w/40/h/40" class="img-circle" alt="">
                </div>
            </div>
            <hr>
...
<script>
    ...
    $(function () {
        ...
        var uploder = WebUploader.create({
            ...
            auto: true,
            fileVal: 'file',
            formData: {'token': '${token}'}  //外部js文件中，token获取不到
        });
            ...
            $.post("/setting?action=avatar", {'fileKey': fileKey})
                .done(function (data) {
                    if (data.state == 'success') {
                        var url = "http://ohwn5gb62.bkt.clouddn.com/" + fileKey;
